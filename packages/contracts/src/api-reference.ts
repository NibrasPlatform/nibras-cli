...
export const API_ENDPOINTS = [
  ...
  { method: 'POST',   path: '/v1/submissions/:submissionId/local-test-result',        auth: true,   tag: 'projects' },
  ...
  { method: 'DELETE', path: '/v1/tracking/courses/:courseId/members/:userId',         auth: true,   tag: 'tracking' },
  { method: 'PATCH',  path: '/v1/tracking/courses/:courseId/members/:userId/level',   auth: true,   tag: 'tracking' },
  ...
  { method: 'POST',   path: '/v1/tracking/projects/:projectId/unpublish',             auth: true,   tag: 'tracking' },
  ...
  { method: 'GET',    path: '/v1/tracking/projects/:projectId/milestones',            auth: true,   tag: 'tracking' },
  { method: 'POST',   path: '/v1/tracking/projects/:projectId/milestones',            auth: true,   tag: 'tracking' },
  ...
  // Tracking – submissions & reviews
  { method: 'GET',    path: '/v1/tracking/milestones/:milestoneId/submissions',       auth: true,   tag: 'tracking' },
  { method: 'POST',   path: '/v1/tracking/milestones/:milestoneId/submissions',       auth: true,   tag: 'tracking' },
  ...
  { method: 'GET',    path: '/v1/tracking/submissions/:submissionId/commits',         auth: true,   tag: 'tracking' },
  { method: 'GET',    path: '/v1/tracking/submissions/:submissionId/review',          auth: true,   tag: 'tracking' },
  { method: 'POST',   path: '/v1/tracking/submissions/:submissionId/review',          auth: true,   tag: 'tracking' },
  { method: 'GET',    path: '/v1/tracking/review-queue',                              auth: true,   tag: 'tracking' },
  // Tracking – teams
  { method: 'POST',   path: '/v1/tracking/projects/:projectId/applications',          auth: true,   tag: 'tracking' },
  { method: 'GET',    path: '/v1/tracking/projects/:projectId/applications/me',       auth: true,   tag: 'tracking' },
  { method: 'GET',    path: '/v1/tracking/projects/:projectId/applications',          auth: true,   tag: 'tracking' },
  { method: 'POST',   path: '/v1/tracking/projects/:projectId/team-formation/generate', auth: true, tag: 'tracking' },
  { method: 'POST',   path: '/v1/tracking/projects/:projectId/team-formation/lock',  auth: true,   tag: 'tracking' },
  { method: 'GET',    path: '/v1/tracking/projects/:projectId/teams',                 auth: true,   tag: 'tracking' },
  { method: 'PATCH',  path: '/v1/tracking/projects/:projectId/teams/:teamId',         auth: true,   tag: 'tracking' },
  // Tracking – dashboards & analytics
  ...
  { method: 'GET',    path: '/v1/programs/:programId/versions/:versionId',            auth: true,   tag: 'programs' },
  ...
  { method: 'POST',   path: '/v1/programs/:programId/requirement-groups',             auth: true,   tag: 'programs' },
  { method: 'PATCH',  path: '/v1/programs/:programId/requirement-groups/:groupId',    auth: true,   tag: 'programs' },
  ...
  { method: 'PATCH',  path: '/v1/programs/:programId/petitions/:petitionId',          auth: true,   tag: 'programs' },
  { method: 'POST',   path: '/v1/programs/:programId/approvals/:studentProgramId/advisor',    auth: true, tag: 'programs' },
  { method: 'POST',   path: '/v1/programs/:programId/approvals/:studentProgramId/department', auth: true, tag: 'programs' },
  // Notifications
